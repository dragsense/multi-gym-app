...
import {
  fetchDoors,
  fetchDoorsByLocation,
  fetchDoor,
  deleteDoor,
} from "@/services/location/door.api";
...
interface IDoorsModalProps extends THandlerComponentProps<
  TListHandlerStore<any, any, any>
> {}

export default function DoorsModal({ storeKey, store }: IDoorsModalProps) {

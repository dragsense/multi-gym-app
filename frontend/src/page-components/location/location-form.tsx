...
import {
  LocationFormModal,
  type ILocationFormModalExtraProps,
...
interface ILocationFormProps extends THandlerComponentProps<
  TSingleHandlerStore<ILocation, TLocationExtraProps>
> {}

export default function LocationForm({ storeKey, store }: ILocationFormProps) {
  ...
  const initialValues = useMemo(() => {
    const defaultValues: TCreateLocationData = {
      name: "",
      address: "",
      image: null,
    };
        ...
        onSuccess={() => {
          startTransition(() => {
            ...
            queryClient.invalidateQueries({
              queryKey: [LOCATION_SELECTION_STORE_KEY + "-list"],
            });
            handleClose();
          });
        }}

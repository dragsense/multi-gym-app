...
import { useAllMemberMembershipHistory } from "@/hooks/use-all-member-membership-history";
import { formatDate, formatDateTime } from "@/lib/utils";
import { buildSentence } from "@/locales/translations";
import { cn } from "@/lib/utils";

interface IMembershipHistoryTimelineProps {
  member: IMember;
  initialLimit?: number;
}
...
export function MembershipHistoryTimeline({ 
  member, 
  initialLimit = 10 
}: IMembershipHistoryTimelineProps) {
      ...
      >
        <div className="flex flex-col items-center justify-center py-12 px-4">
          ...
          <p className="text-sm font-medium text-foreground mb-1">
            {buildSentence(t, "no", "membership", "history", "found")}
          </p>
          <p className="text-xs text-muted-foreground text-center max-w-sm">
            {buildSentence(t, "membership", "history", "will", "appear", "here")}
          </p>
        </div>
      </AppCard>
    );

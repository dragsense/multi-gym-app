...
export function RecentSessionsCard({ member }: IRecentSessionsCardProps) {
  const componentId = useId();

  // Fetch sessions using hook with pagination
  const { data: sessions, isLoading, pagination, setPage, setLimit } = useMemberSessions({
    memberId: member.id,
    params: {
...
// SessionItem component (moved from session-item.tsx)

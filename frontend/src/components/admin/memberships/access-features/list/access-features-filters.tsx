...
interface IAccessFeaturesFiltersProps {
  store: TListHandlerStore<IAccessFeature, TAccessFeatureListData, any>;
}

export function AccessFeaturesFilters({
  store,
}: IAccessFeaturesFiltersProps) {
  ...
  const inputs = useInput<TAccessFeatureListData>({
    fields: fields as TFieldConfigObject<TAccessFeatureListData>,
  });

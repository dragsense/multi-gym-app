...
interface IMembershipFiltersProps {
  store: TListHandlerStore<IMembership, TMembershipListData, any>;
}
...
export function MembershipFilters({
  ...
  const inputs = useInput<TMembershipListData>({
    fields: fields as TFieldConfigObject<TMembershipListData>,
  });

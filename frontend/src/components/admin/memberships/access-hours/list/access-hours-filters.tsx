...
interface IAccessHoursFiltersProps {
  store: TListHandlerStore<IAccessHour, TAccessHourListData, any>;
}

export function AccessHoursFilters({
  store,
}: IAccessHoursFiltersProps) {
  ...
  const inputs = useInput<TAccessHourListData>({
    fields: fields as TFieldConfigObject<TAccessHourListData>,
  });

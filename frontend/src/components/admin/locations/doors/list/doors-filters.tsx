...
interface IDoorsFiltersProps {
  store: TListHandlerStore<IDoor, TDoorListData, any>;
}

export function DoorsFilters({
  store,
}: IDoorsFiltersProps) {
  ...
  const inputs = useInput<TDoorListData>({
    fields: fields as TFieldConfigObject<TDoorListData>,
  });

...
import type { TaskListDto } from "@shared/dtos";

interface ITaskFiltersProps {
  store: TListHandlerStore<ITask, TaskListDto, any>;
}
...
export function TaskFilters({
  ...
  const inputs = useInput<TaskListDto>({
    fields: filteredFields as TFieldConfigObject<TaskListDto>,
  });

...
import type { BannerImageListDto } from "@shared/dtos";

interface IBannerImageFiltersProps {
  store: TListHandlerStore<IBannerImage, any, any>;
}

export function BannerImageFilters({ store }: IBannerImageFiltersProps) {
  ...
  const inputs = useInput<any>({
    fields: filteredFields as TFieldConfigObject<BannerImageListDto>,
  });

...
import type { TPermissionListData } from "@shared/types";
...
interface IPermissionFiltersProps {
  store: TListHandlerStore<IPermission, any, any>;
}

export function PermissionFilters({ store }: IPermissionFiltersProps) {
  ...
  const inputs = useInput<TPermissionListData>({
    fields: filteredFields as TFieldConfigObject<TPermissionListData>,
  });

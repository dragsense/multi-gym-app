...
const PermissionsSelect = React.memo((props: TCustomInputWrapper) => (
...
interface IRoleFormModalProps extends THandlerComponentProps<
  TFormHandlerStore<TRoleData, any, IRoleFormModalExtraProps>
> {}
...
export const RoleFormModal = React.memo(function RoleFormModal({
  ...
  const fields = useMemo(
    () =>
      ...
      }) as TFieldConfigObject<TRoleData>,
    [storeFields],
  );

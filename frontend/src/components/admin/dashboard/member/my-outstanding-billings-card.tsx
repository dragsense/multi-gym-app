...
/**
 * Card component that displays outstanding billings for the logged-in member
 * Uses useMyOutstandingBillings hook directly - no props needed
 */
export function MyOutstandingBillingsCard() {
    ...
    <AppCard
      header={
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-lg font-semibold">Outstanding Billings</h3>
        </div>
      }
    ...
    >
      <div className="space-y-4">
        <div className="space-y-2">
          <div className="flex items-center justify-between bg-red-100 dark:bg-red-900/20 p-2 rounded-md">
            <div className="flex items-center gap-2">

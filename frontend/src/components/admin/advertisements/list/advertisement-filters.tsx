...
import type { AdvertisementListDto } from "@shared/dtos";

interface IAdvertisementFiltersProps {
  store: TListHandlerStore<IAdvertisement, any, any>;
}

export function AdvertisementFilters({ store }: IAdvertisementFiltersProps) {

...
interface ICheckinBackDoorButtonProps {
    onSuccess?: () => void;
}

export function CheckinBackDoorButton({ onSuccess }: ICheckinBackDoorButtonProps) {
    const { t } = useI18n();
    ...
    // Hardcoded macAddress for Back Door Checkin Device
    const macAddress = "20:20:20:20";
    const deviceName = "Back Door Checkin Device";

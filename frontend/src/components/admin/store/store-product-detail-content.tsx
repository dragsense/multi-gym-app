...
import QuillViewer from "../../shared-ui/quill-viewer";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-1">
        ...
        <div className="space-y-6">
          ...
          <div className="text-3xl lg:text-4xl font-bold text-primary">
            {formatCurrency(currentPrice, undefined, undefined, 2, 2, settings)}
          </div>
          ...
          <div className="flex items-center gap-3 text-sm">
            <div className="flex items-center gap-2 text-green-600">
              ...
              <span className="font-medium">
                {t("inStock") || "In Stock"} ({currentStock})
              </span>
            </div>
            {currentSku && (
              <>
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                className="h-10 w-10 rounded-md"
                onClick={() =>
                  setQuantity((q) => Math.min(currentStock || 99, q + 1))
                }

...
interface IVerifyOtpFormProps extends THandlerComponentProps<
  TFormHandlerStore<TVerifyOtpData, IMessageResponse, TVerifyOtpExtraProps>
> {}
...
export default function VerifyOtpForm({
  ...
  return (
    <Form<TVerifyOtpData, IMessageResponse> formStore={store}>
      <AppCard
        header={
          <>
            <h2 className="text-md font-semibold">{t("verifyOtpHeading")}</h2>
            <p className="text-sm text-muted-foreground">
              {t("verifyOtpSubheading")}
            </p>
          </>
        }
        footer={
